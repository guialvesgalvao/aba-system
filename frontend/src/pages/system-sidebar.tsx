...
export function SystemSidebar(props: Readonly<ISystemSidebarProps>) {
  ...
  return (
    <aside
      id="system-sidebar"
      className={cn(
        "bg-background w-full h-full group flex flex-col gap-4 data-[collapsed=true]:py-2 border-r fixed transition-colors z-50 border-b md:border-b-0 max-h-20 md:max-h-none",
    ...
    >
      ...
      <div
        id="sidebar-collapse-wrapper"
        className="top-1/2 -right-3 absolute hidden md:flex"
      >
        <CollapseButton />
      </div>
