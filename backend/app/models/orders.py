...
class Orders(db.Model):
    ...
    client_name = db.Column(db.String(255), default=None)
    ...
    client_address = db.Column(db.String(255), default=None)
    ...
    def as_dict(self):
        return {
            ...
            'invoicing_date': self.invoicing_date.isoformat() if self.invoicing_date else None,
